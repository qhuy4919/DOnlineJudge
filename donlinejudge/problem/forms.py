        ...
        try:
            ...
            try:
                ...
                raise ValidationError(
                    _(
                        "display_id should only contains lowercase alphabet character or digits"
                    ),
                    code="invalid",
                )
            ...
            for obj in cdata["sample_test"]:
                if obj.keys() != good_sample_elem.keys():
                    ...
                    raise ValidationError(
                        _(
                            "Invalid key-value pair in sample_test array: %(key)s: %(value)s"
                        ),
                        code="invalid",
                        params={
                            "key": alien,
            ...
            raise ValidationError(
                ...
                code="invalid",
                params={"keyname": ke, "value": self.data.get(ke)},
            )
